<?php
// in sync with: https://github.com/FriendsOfPHP/PHP-CS-Fixer/commit/e55aa52679a7bb9c45657aa4107851296a8cf16a
...
return PhpCsFixer\Config::create()
    ...
    ->setRules(
        [
            ...
            'php_unit_dedicate_assert' => true, //  [@Symfony:risky]
            ...
            'pow_to_exponentiation' => true, //  [@PHP56Migration, @PHP70Migration, @PHP71Migration:risky]
            'pre_increment' => true, //  [@Symfony]
            'print_to_echo' => true, //  [@Symfony]
            'psr0' => false, // [:risky]
            'psr4' => true, // [:risky]
            'random_api_migration' => true, //  [@PHP70Migration, @PHP71Migration:risky]
